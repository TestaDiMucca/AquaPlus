      ...
      <div>
          ...
          <TopAppBar.Row>
            <TopAppBar.Section align-start>
              ...
              <TopAppBar.Title
                ...
                onClick={this.goHome}
              >
                <img class={style.smolIcon} src={smolThing} />
                Agua+
              </TopAppBar.Title>
            </TopAppBar.Section>
        ...
        <Drawer modal ref={this.drawerRef}>
          <Drawer.DrawerContent>
            ...
            <Drawer.DrawerItem
              selected={props.selectedRoute === '/upload'}
            ...
            <Drawer.DrawerItem
              selected={props.selectedRoute === '/bugs'}
              onClick={this.goToBugs}
            >
